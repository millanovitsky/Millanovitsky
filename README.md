...
🔬 Física e Ciências da Natureza  
⚛️ Modelagem e visualização científica  
🧑‍🏫 Ensino de Física para Ensino Médio  
🧩 Simulações interativas para educação  
🌌 Sistemas de partículas e visualizações 3D  
...
<img src="https://img.shields.io/badge/Unity-007BFF?style=for-the-badge&logo=unity&logoColor=white">

<img src="https://img.shields.io/badge/Blender-007BFF?style=for-the-badge&logo=blender&logoColor=white">
...
- Planos de aula de Física
- Experimentos didáticos
- Oficinas científicas
- Simulações para ensino

Meu objetivo é **aproximar ciência e tecnologia da educação básica**, tornando o aprendizado mais visual, experimental e investigativo.
...
> "A ciência não é apenas conhecimento, é uma forma de enxergar o mundo."

Coffee with Science ☕🔬

<!--
**millanovitsky/Millanovitsky** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
